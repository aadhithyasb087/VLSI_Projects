class rand_baud extends uvm_sequence#(uart_xtn);
...
//////////////////////////////////////////////////////////
class rand_baud_with_stop extends uvm_sequence#(uart_xtn);
...
class rand_baud_len5p extends uvm_sequence#(uart_xtn);
...
class rand_baud_len6p extends uvm_sequence#(uart_xtn);
...
class rand_baud_len7p extends uvm_sequence#(uart_xtn);
...
class rand_baud_len8p extends uvm_sequence#(uart_xtn);
...
class rand_baud_len5 extends uvm_sequence#(uart_xtn);
...
class rand_baud_len6 extends uvm_sequence#(uart_xtn);
...
class rand_baud_len7 extends uvm_sequence#(uart_xtn);
...
class rand_baud_len8 extends uvm_sequence#(uart_xtn);
