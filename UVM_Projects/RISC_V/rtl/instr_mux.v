module instr_mux(flush_in,  ms_riscv32_mp_instr_in,  opcode_out,  funct3_out,
funct7_out,  rs1addr_out,rs2addr_out,  rdaddr_out,  csr_addr_out,  instr_out);
...
output [4:0]rs2addr_out,rdaddr_out;
...
begin
	if(flush_in)
		instr_mux=32'h000013;
	else
		instr_mux=ms_riscv32_mp_instr_in;
